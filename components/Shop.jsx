...
export default function Shop() {
    return (
        <section className='p-10 flex flex-col gap-10 items-center font-light text-[#99242A]'>
            <h1>Trending</h1>
            <section className='flex h-96 justify-center gap-8'>
                ...
                <section className='w-[20%] flex flex-col gap-3'>
                    ...
                    <button className='text-white bg-[#99242A] hover:bg-[#af2e34] tracking-wider p-3'>VIEW THIS PRODUCT</button>
                </section>
            </section>
        </section>
    )
