                ...
                {footer.map((item, index) => {
                    return <div key={index} className='w-full flex flex-col gap-2 text-sm'>
                        ...
                        {index === 0 && <div className='flex gap-2'>
                            ...
                            <BiLogoInstagramAlt className='w-6 h-6 hover:text-[#99242A] cursor-pointer' />
                            <BiLogoPinterest className='w-6 h-6 hover:text-[#99242A] cursor-pointer' />
                        </div>}
                        {index === 3 && <div className='flex flex-col gap-2'>
                            ...
                            <button className='p-3 px-4 bg-[#99242A] hover:bg-[#b92c33] text-white w-fit my-2'>SUBSCRIBE</button>
                        </div>}
                    </div>;
                })}
            </section>
