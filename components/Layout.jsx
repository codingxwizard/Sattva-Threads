...
export default function Layout({ children }) {
    ...
    return (
        <>
            ...
            <Link href={location ? "/" : "/admin/dashboard"} ><span className='fixed z-50 left-0 bottom-0 text-lg text-red-500 border border-red-500 p-3 px-4 hover:scale-110 transition-transform rounded m-8 bg-red-100'>{location ? "Customer" : "Admin"}</span></Link>
            <Footer />
        </>
    )
}
