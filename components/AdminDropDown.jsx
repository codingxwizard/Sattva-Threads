...
export default function AdminDropDown() {
    ...
    const handleClickOutside = (event) => {
        if (buttonRef.current && !buttonRef.current.contains(event.target)) {
            ...
            setTimeout(() => {
                ...
                menuRef.current.style.animation = "dropDownAppear 0.3s ease-in-out";
            }, 250);
        }
    };
    ...
    return (
        <div className='flex flex-col relative w-1/2'>
            ...
            <div ref={menuRef} className='absolute max-h-60 overflow-y-auto hidden w-full drop-down-appear flex-col top-full my-3 border border-slate-300 bg-white rounded'>
